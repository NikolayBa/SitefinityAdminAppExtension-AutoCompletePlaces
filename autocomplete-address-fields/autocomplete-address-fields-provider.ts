...
import { CustomAddressAutocompleteFieldSettings } from "./autocomplete-address-field.settings";

// import { CustomInputWriteComponent } from "../custom-fields/custom-field-write.component";
// import { CustomInputReadonlyComponent } from "../custom-fields/custom-field-readonly.component";
// import { CustomShortTextSettings } from "../custom-fields/custom-field.settings";

/**
 * The fields provider provides the overridden fields back to the AdminApp.
 */
@Injectable()
export class CustomAddressAutocompleteFieldsProvider implements FieldsProvider {
    ...
    private registerCustomComponents(): void {
        ...
        const customInputRegistration: FieldRegistration = {
            writeComponent: CustomAddressAutocompleteFieldInputWriteComponent,
            readComponent: CustomAddressAutocompleteFieldInputReadonlyComponent,
            settingsType: CustomAddressAutocompleteFieldSettings
        };
...
export const CUSTOM_FIELDS_PROVIDER: ClassProvider = {
    ...
    useClass: CustomAddressAutocompleteFieldsProvider,
    multi: true
};
